# Имеется парль неизвестной длины. Есть набор из 50 цифр - части этого пароля (1я, 3я и 6я например).
# Найти наименьшую длину пароля, удовлетворяющую набору (73162890)

@keys = %w(319 680 180 690 129 620 762 689 762 318 368 710 720 710 629 168 160 689 716 731 736 729 316 729 729
