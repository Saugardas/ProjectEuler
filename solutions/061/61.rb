# Найти сумму набора из 6 числе, таких что они - образует цепочку (две последние цифры 1го ичсла - две первые цифры последнего) и каждое из чисел является 3, 4, 5, 6, 7, 8-угольным числом
